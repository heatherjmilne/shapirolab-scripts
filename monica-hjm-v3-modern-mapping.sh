...
#   This is the MAPPING script, which runs BWA, Samtools, and MapDamage.
...
BAM_MIN_QUALITY=30	                                                                            # Provides a fairly low cutoff
...
echo "Nuclear alignment steps are complete."
echo "#######################################################"
